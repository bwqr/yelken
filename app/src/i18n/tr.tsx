...
export const locale: typeof en.locale = {
    actions: {
        ...
        setDefault: (name: string) => `"${name}" isimli dil varsayılan olarak güncellendi`,
    ...
    labels: {
        ...
        namePlaceholder: 'Dilin ismi, örnk. Türkçe',
        keyPlaceholder: 'Dili tanımlayacak anahtar, örnk. tr',
